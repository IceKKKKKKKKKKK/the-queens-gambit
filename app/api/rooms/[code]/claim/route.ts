...
export async function POST(
  ...
  try {
    ...
    const body = (await request.json().catch(() => null)) as { inviteToken?: unknown; playerToken?: unknown } | null;
    if (
      !body ||
      typeof body.inviteToken !== "string" ||
      typeof body.playerToken !== "string" ||
      !/^[A-Za-z0-9_-]{20,}$/.test(body.inviteToken) ||
      !/^[A-Za-z0-9_-]{20,}$/.test(body.playerToken) ||
