...
| 机制参数指纹 | `2918025817` |
| 产品稳定性算法 | `product-stability-v15-v3-no-clock-zero-time-deterministic-ids-slot-stable-drafts-relocation-aware-worlds` |
| 对局引擎指纹 | `augment-duel-dark-v3:threefold-3:strategic-sha256-v2` |
| 当前结论 | 70 张已进入服务端规则；最终发布回归 251/251 通过，正式四小时持续测试与 Sites 部署仍须基于冻结提交完成 |
...
- 最终完整回归 251/251 通过：HTML 9 项、集成服务器契约 4 项、TypeScript 235 项、真实集成 3 项；
